...
function Navbar(){
    ...
    // const cart = useSelector((state) => state.auth.isLoggedIn);
    ...
    return(
        ...
        <nav className="navbar navbar-expand-lg">
            ...
            <div className="collapse navbar-collapse" id="navbarMark">
                ...
                <div className="px-2 justify-content-center" style={{float:'right'}}>
                    {!displayName&&<>
                    ...
                    {displayName&&<>
                        ...
                        <div className="btn btn-outline" style={{backgroundColor:'#073418',color:'#A2DBB7', float:'right'}} onClick={logoutUser}>LOGOUT</div>
                    </>}
